...
This page is being expanded as coverage of rule types is added to version 0.10.0 of Tabulae.
:::
...
vbullets = map(s -> "1. " * inflectionType(s), vrules) |> unique |> sort
...
pbullets = map(s -> "1. " * inflectionType(s), prules) |> unique |> sort
...
bullets = map(s -> "1. " * inflectionType(s), nounrules) |> unique |> sort
