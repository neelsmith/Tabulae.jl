...
- `latinForm`.  The `formurn` function is implemented by the stem type for regular inflected forms; for irregular forms and uninflected forms (includling pronouns), the `formurn` function is implemented for the rule type.
...
- `latinForm`: gets a Latin morphological form from an analysis, a rule or a stem
